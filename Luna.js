...
// A lightweight simple translation module with dynamic JSON storage.
     i18n          = require("i18n"           ),
...
// Loads the language dictionary
      ...
      Glossary      = new (require(`./resources/Languages/English.js`))(),
...
i18n.configure({
    locales: ["en"],
    directory: join(__dirname, "resources/Languages"),
    defaultLocale: "en",
...
/*
    ...
    if (score.Lvl < Lvl) {
        message.reply(`Level up ! you're now level ${Lvl} ! Hope that wasnt from spamming Hentai !`);
    }
            ...
            client.func.delAfterSend(client, message, ({
                embed: {
                    ...
                    fields: [
                        {
                            name: "User's Guide",
                            value: `The correct use would be: \`${settings.Prefix}${Commande.usage}\``,
                        }
                    ],
                    footer: {
