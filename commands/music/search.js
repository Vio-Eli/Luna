...
const { YOUTUBE_API_KEY, LOCALE } = require("../../resources/musicutil");
        ...
        try {
            ...
            if (reply.includes(",")) {
                ...
                for (let song of songs) {
                    ...
                    .get("play")
                    .execute(Glossary, client, message, [resultsEmbed.fields[parseInt(song) - 1].name]);
                }
            } else {
                const choice = resultsEmbed.fields[parseInt(response.first()) - 1].name;
                message.client.commands.get("play").execute(Glossary, client, message, [choice]);
            }
